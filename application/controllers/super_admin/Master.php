		...
		if ($dt == 'viewList') {
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$updtArr = array(
					...
					'modified_id' => $this->logId, 'staff_id' => $post['staffID'], 'modified_date' => date('Y-m-d')
				);
		...
		if ($dt == 'viewList') {
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$updtArr = array(
					...
					'modified_id' => $this->logId, 'modified_date' => date('Y-m-d')
				);
		...
		if ($dt == 'viewList') {
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$createArr = array(
					...
					'created_id' => $this->logId, 'create_date' => date('Y-m-d')
				);
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$updtArr = array(
					...
					'opening_date' => $post['openingDate'],
					'modified_by' => $this->logId, 'modified_date' => date('Y-m-d')
				);
