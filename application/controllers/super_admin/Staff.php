    ...
    class Staff extends CI_Controller
    {
        ...
        public function staff_data()
        {
            ...
            foreach ($record as $row) {
                ...
                $status = ($row->status == 1) ? '
                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target=".assign_model" style="margin-left:-5px;" onclick="assign_staff(' . $row->id . ')" title="Click to View Staff Details"><i class="fas fa-check text-success"></i></a>&emsp;'
                :
                '<a style="color:red; margin-left:-5px;"  href="javascript:void()" title="permanently deactivate"><b><i class="fas fa-times text-danger"></i> </b></a>&emsp;';
