<?php
    ...
    class Staff extends CI_Controller
    {
        public function __construct()
        {
            ...
            $this->load->model('employee/Staff_model', 'staff_model');
        ...
        public function add_staff() {
            ...
            $data['designation_nm'] = $this->staff_model->all_designation();
        ...
        public function staff_data()
        {
            ...
            foreach ($record as $row) {  
                ...
                $status = ($row->status == 1) ? '
                <a style="color:green; margin-left:-5px;" href="javascript:void(0)" onClick="return changeStatus_1(\'' . $row->id . '\',\'0\',\' staff\',\'employee/common_model/chageStatus\')" title="Click to Di-Active Staff"><b><i class="fa fa-check"></i> </b></a>&emsp;'
                :
                '<a style="color:red; margin-left:-5px;"  href="javascript:void(0)"  onClick="return changeStatus_1(\'' . $row->id . '\',\'1\',\' staff\',\'employee/common_model/chageStatus\')" title="Click to Active Staff"><b><i class="fa fa-times"></i> </b></a>&emsp;';
        ...
        public function view_staff() {
            ...
            if($this->input->is_ajax_request()) {
                ...
                $this->load->view('employee/staff/view_staff', $data);
        ...
        public function update_staff() {
            ...
            if($this->input->is_ajax_request()) {
				...
				$data['getBranch']=$this->common_model->all_data_con('master_branch',array('status'=>'1'),'id,br_id,branch_name');
                $this->load->view('employee/staff/update_staff', $data);
