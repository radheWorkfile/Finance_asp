    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="first_name" id="first_name" value="<?php echo $upd_memb['first_name'] ?>" maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Mid Name </label>
                <input class="form-control" type="text" name="mid_name" id="mid_name" value="<?php echo $upd_memb['mid_name'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Last Name <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="last_name" id="last_name" value="<?php echo $upd_memb['last_name'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="state" id="state" value="<?php echo $upd_memb['state'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">District </label>
                <input class="form-control" type="text" name="district" id="district" value="<?php echo $upd_memb['district'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Village </label>
                <input class="form-control" type="text" name="village" id="village" value="<?php echo $upd_memb['village'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Post Office </label>
                <input class="form-control" type="text" name="p_office" id="p_office" value="<?php echo $upd_memb['p_office'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Police Station </label>
                <input class="form-control" type="text" name="p_station" id="p_station" value="<?php echo $upd_memb['p_station'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Pin Code </label>
                <input class="form-control" type="text" name="pin_code" id="pin_code" value="<?php echo $upd_memb['pin_code'] ?>" maxlength="11" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
            </div>
        </div>
        <!-- <div class="col-lg-4">
            <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="aadhar_card_no" id="aadhar_card_no" value="<?php echo $upd_memb['aadhar_card_no'] ?>"maxlength="12" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label for="example-number-input" class="form-label">Voter Card No. </label>
                <input class="form-control" type="text" maxlength="12" name="voter_card_no" id="voter_card_no" value="<?php echo $upd_memb['aadhar_voter_no'] ?>"maxlength="80"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="nominee_name" id="nominee_name" value="<?php echo $upd_memb['nominee_name'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <!-- <div class="col-lg-4">
            <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="nominee_voter" id="nominee_voter" value="<?php echo $upd_memb['nominee_voter'] ?>"maxlength="12"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Guarantor Address </label>
                <textarea class="form-control" type="text" name="nominee_address" id="nominee_address" value="<?php echo $upd_memb['nominee_address'] ?>"maxlength="80"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');"></textarea>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="number" name="account_no" id="account_no" value="<?php echo $upd_memb['account_no'] ?>"maxlength="12" oninput="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="branch_name" id="branch_name" value="<?php echo $upd_memb['branch_name'] ?>" maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
        <div class="col-lg-4">
            <div class="mb-3">
                <label class="form-label">Bank Name</label>
                <input class="form-control" type="text" name="bank_name" id="bank_name" value="<?php echo $upd_memb['bank_name'] ?>"maxlength="25" oninput="this.value = this.value .toLowerCase() .replace(/[^a-z ]/g, '').replace(/\s+/g, ' ').replace(/\b\w/g, char => char.toUpperCase());">
            </div>
        </div>
    </div>
</section>
