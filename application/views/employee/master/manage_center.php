...
<span id="adBtnActn">employee/master/center/addNew</span>
<span id="minBtnActn">employee/master/center/cStatus</span>
...
<form id="villageMaster" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    <div class="row" id="vCreateNew" style="display:none;">
        ...
        <div class="col-lg-3">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="noGroup" id="noGroup" value="6" readonly>
            </div>
        </div>
 ...
 <input type="hidden" id="locTrgt" value="employee/master/center/cStatus">
<!-- JavaScript -->
