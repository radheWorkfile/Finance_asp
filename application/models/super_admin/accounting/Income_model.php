<?php
    ...
    class Income_model extends CI_Model
    {
        ...
        public function all_income($where = false) 
        {
              ...
              $this->db->select('inc.*,sum(inc.amount) as inc_all_amount,inc_sou.source_name');
              $this->db->join('income_sources as inc_sou','inc_sou.id = inc.source');
            ...
            $this->db->group_by('inc_sou.source_name');
            return $this->db->get('income as inc')->result_array();
        ...
        {
             $this->db->select('exp.*,sum(exp.amount) as all_amount,ex_cat.exp_name');
             ...
             $this->db->group_by('ex_cat.exp_name');
